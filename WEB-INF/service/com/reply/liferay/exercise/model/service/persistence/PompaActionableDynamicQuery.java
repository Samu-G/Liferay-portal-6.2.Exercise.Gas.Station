 ...
 * @generated
 */
public abstract class PompaActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public PompaActionableDynamicQuery() throws SystemException {
		setBaseLocalService(PompaLocalServiceUtil.getService());
		setClass(Pompa.class);

		setClassLoader(com.reply.liferay.exercise.model.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("pompaId");
	}
}