 ...
 * @generated
 */
public abstract class StazioneDiRifornimentoActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public StazioneDiRifornimentoActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(StazioneDiRifornimentoLocalServiceUtil.getService());
		setClass(StazioneDiRifornimento.class);

		setClassLoader(com.reply.liferay.exercise.model.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("stazioneDiRifornimentoId");
	}
}